        ...
        <div className="py-5">
          <div className="text-4xl font-medium w-[85%] m-auto">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 py-10">
              {admin_products?.data?.data?.data?.map((prod, index) => (
                <>
                  <article key={index} className="relative flex flex-col overflow-hidden rounded-lg border">
                    ...
                    <div className="my-4 mx-auto flex w-10/12 flex-col items-start justify-between">
                      <div className="mb-2 flex">
                        <p className="mr-3 text-sm font-semibold">{prod?.price} PKR</p>
                        {/* <del className="text-xs text-gray-400"> $79.00 </del> */}
                      </div>
                      <h3 className="mb-2 text-sm text-gray-400">{prod?.title}</h3>
                    </div>
                    <button className="group mx-auto mb-2 flex h-10 w-10/12 items-stretch overflow-hidden rounded-md text-gray-600">
                      <button  onClick={() => addToCart(prod)} className="flex w-full items-center justify-center bg-gray-100 text-xs uppercase transition group-hover:bg-emerald-600 group-hover:text-white">
                        Buy Now
                      </button>
